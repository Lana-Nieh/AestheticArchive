...
const dict: Dict = {
  ...
  'agent.launcher.auto_tag_desc': { en: '14 untagged',                zh: '14 项未打标' },
  'agent.launcher.suggest':     { en: 'Suggest collections',          zh: '建议收藏夹' },
  'agent.launcher.suggest_desc':{ en: '3 candidates',                 zh: '3 个候选' },
  'agent.launcher.duplicates':  { en: 'Find duplicates',              zh: '查找重复' },
  'agent.launcher.duplicates_desc': { en: '6 likely pairs',           zh: '约 6 对可能重复' },
